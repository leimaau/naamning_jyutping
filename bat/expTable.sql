...
select trad||'	'||jyutping from tab_nbdict_2020_phrase where trad not like '%～%' order by tab_id;
...
select trad||'	'||jyutping from tab_nbdict_2020_bw_phrase where trad not like '%～%' order by tab_id;
